...
if __name__ == "__main__":
    ...
    numel_sub = np.prod([d+80 for d in shape])/9
    ...
    g1 = adjoint_born(model, dD if args.born else dobs, u=utrue, v=v1, dt=dt, isiciso=args.isic)
    # Save to S3 bucket.
    write_to_s3(g1, name='2d-grad.npy', ext='Overthrust_tti.npy')
