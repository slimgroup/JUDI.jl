...
opt = Options(save_data_to_disk=false, file_path=pwd(), file_name="observed_shot", optimal_checkpointing=false, isic=false, subsampling_factor=1)
...
nfreq = 1
J.options.frequencies = Array{Any}(undef, dD.nsrc)
for j=1:dD.nsrc
