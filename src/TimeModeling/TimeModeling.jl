...
include("Types/judiInitialValue.jl")    # Initial values
...
include("Modeling/initial_value_interface_serial.jl")  # forward/adjoint linear/nonlinear modeling w/ initial value 
...
include("LinearOperators/judiInitial.jl")   # RHS for initial value
...
include("LinearOperators/judiPDEinitial.jl")   # modeling operator for initial value
